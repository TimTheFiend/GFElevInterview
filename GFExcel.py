...
CHANGELOG:
    ...
    29/09-21: Små ændringer til script, fokus på `print_students`.
"""
import sys
import openpyxl
...
def print_students() -> None:
    ...
    for cpr, fornavn, efternavn in STUDENT_LIST:
        print(";".join([cpr, fornavn, efternavn]))
...
def main(file_path : str) -> None:
    ...
    for x in range(2, SHEET.max_row + 1):  # `range(2` since row 1 is the column names, and `+ 1` to get the last row as well.
