       ...
       // public DbSet<ElevModel> Elever { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            modelBuilder.Entity<ElevModel>().HasData(
                ...
                new ElevModel { cprNr = "1111931234", fornavn = "Joakim0", efternavn = "Krugstrup", sps = true, eud = false},
                new ElevModel { cprNr = "0101004321", fornavn = "Peder", efternavn = "Eriksen", eud = true, sps = true },
                ...
                new ElevModel { cprNr = "1181931234", fornavn = "Joakim2", efternavn = "Krugstrup", eud = true, sps = true },
                new ElevModel { cprNr = "1191931234", fornavn = "Joakim3", efternavn = "Krugstrup" },
                new ElevModel { cprNr = "1141931234", fornavn = "Joakim4", efternavn = "Krugstrup", sps = true, eud = false },
                new ElevModel { cprNr = "1152931234", fornavn = "Joakim5", efternavn = "Krugstrup" },
                new ElevModel { cprNr = "1181231234", fornavn = "Joakim6", efternavn = "Krugstrup", eud = true, sps = false },
                new ElevModel { cprNr = "1191951234", fornavn = "Joakim7", efternavn = "Krugstrup" },
                new ElevModel { cprNr = "1141901234", fornavn = "Joakim8", efternavn = "Krugstrup", sps = true, eud = false },
                ...
                new ElevModel { cprNr = "1101901234", fornavn = "Joakim12", efternavn = "Krugstrup", sps = true, eud = false },
